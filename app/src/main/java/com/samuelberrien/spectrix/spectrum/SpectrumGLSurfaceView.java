...
public class SpectrumGLSurfaceView extends GLSurfaceView {
	...
	public SpectrumGLSurfaceView(Context context/*, boolean useSample, boolean isPortrait*/) {
		...
		this.isPortrait = context.getResources().getConfiguration().orientation == ORIENTATION_PORTRAIT ? true : false;
	...
	private void setupVisualizerAndAsyncTask() {
		if (this.mVisualizer == null || !this.mVisualizer.getEnabled()) {
			...
			this.mVisualizer.setMeasurementMode(Visualizer.MEASUREMENT_MODE_PEAK_RMS);
			this.mVisualizer.setEnabled(true);
		}
		if (this.getFft == null || this.getFft.getStatus() == AsyncTask.Status.FINISHED) {
