...
public class Room implements Visualization {
	...
	public void init(Context context, boolean isVR) {
		...
		scale = 1f;
		cadreD = new ObjVBO(context, "obj/room/room_cadre.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		cadreG = new ObjVBO(context, "obj/room/room_cadre.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		cadreM = new ObjVBO(context, "obj/room/room_cadre.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		cadreAD = new ObjVBO(context, "obj/room/room_cadre.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		cadreAG = new ObjVBO(context, "obj/room/room_cadre.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		cadreAM = new ObjVBO(context, "obj/room/room_cadre.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		lampeChevetD = new ObjVBO(context, "obj/room/room_lampe_chevet.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		lampeChevetG = new ObjVBO(context, "obj/room/room_lampe_chevet.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		lampePlafond = new ObjVBO(context, "obj/room/room_lampe_plafond.obj", 1f, 1f, 1f, LIGHTAUGMENTATION, DISTANCECOEFF);
		lit2Places = new ObjVBO(context, "obj/room/room_lit_2_places.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		murs = new ObjVBO(context, "obj/room/room_murs.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		oreillerD = new ObjVBO(context, "obj/room/room_oreiller.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		oreillerG = new ObjVBO(context, "obj/room/room_oreiller.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		porte = new ObjVBO(context, "obj/room/room_porte.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		stores = new ObjVBO(context, "obj/room/room_stores.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		tableChevetD = new ObjVBO(context, "obj/room/room_table_chevet.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		tableChevetG = new ObjVBO(context, "obj/room/room_table_chevet.obj", rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), LIGHTAUGMENTATION, DISTANCECOEFF);
		isInit = true;
	}
